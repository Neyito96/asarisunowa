  ...
  return (
    <form className="autoUpdateForm" onSubmit={submit}>
      ...
      <div className="autoUpdateAfterSubmit">
        <b>申請後の流れ</b>
        <p><b>Spotify：</b>共同編集を確認できれば通常は数分後、間に合わない場合は翌朝4〜5時に開始します。初回は不足回を最大100件追加し、残りは翌朝以降、毎朝4〜5時に最大100件ずつ追加します。</p>
        <p><b>朝リスの田への掲載：</b>毎時17分ごろにデータを取り込みます。通常は送信から1時間以内、公開処理を含めても最大約90分が目安です。</p>
