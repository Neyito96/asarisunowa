  ...
  useEffect(() => {
    ...
    const mountWhenReady = () => {
      ...
      if (!mount) {
        ...
        mount.setAttribute("aria-label", "プレイリストをつくる・育てる");
        ...
        ? createPortal(
            <div>
              <div className="playlistSubmitHead">
                <div>
                  <p className="kicker">GROW YOUR LIST</p>
                  <h3>リストを育てる！</h3>
                  <p>
                    朝日新聞ポッドキャストのエピソードを、シリーズ・出演者・テーマなどでまとめたプレイリストを登録できます。Spotifyなら、新しい回を探して自動で追加することもできます。
                  </p>
